...
- (void)viewDidLoad
{
    ...
    searchYT = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 70, 320, 44)];
    searchYT.placeholder = @"Search YouTube";
    searchYT.delegate = self;
    [self.tableView setTableHeaderView:searchYT];
